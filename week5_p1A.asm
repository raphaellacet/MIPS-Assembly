...
# Output:	Decimal values for f_ten and g_ten, 
#               and Binary values for f_two and g_two
#################################################### Data segment ####################################################################
.data
...
##### print result f binary ##########################################################################################################	

	li	$v0, 4			# print string code 4
	la	$a0, msg3
	syscall
	
	move	$a0, $s5		# f = (A^4) - 4(B^3) + 3(C^2) - 2D ( binary )
	li	$v0, 35			# print binary code 35
	syscall
...
##### print result g binary ##########################################################################################################	

	li	$v0, 4			# print string code 4
	la	$a0, msg5
	syscall
	
	move	$a0, $t8		# g = A(B^2) + (C^2)(D^3) ( binary )
	li	$v0, 35			# print binary code 35
	syscall
